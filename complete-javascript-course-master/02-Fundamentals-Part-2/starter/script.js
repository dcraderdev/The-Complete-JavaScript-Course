...
for (let exercise = 1; exercise <= 3; exercise++) {
  ...
  for (let rep = 1; rep <= 6; rep++)
    console.log(`Lifting weights! On exercise ${exercise}, rep  #${rep}! 🏋🏾‍♂️`);
}
...
let rep = 1;
while (rep <= 10) {
  console.log(`Lifting weights! On rep #${rep}! 🏋🏾‍♂️`);
  rep++;
}
...
while (dice !== 6) {
  console.log(`You rolled a ${dice}, keep going!`);
  dice = Math.trunc(Math.random() * 6) + 1;
  if (dice === 6) console.log(`You rolled a ${dice}, niiiiice.`);
